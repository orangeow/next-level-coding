...
let cutDay = Math.floor(Math.random() * (31 - 7 + 1) + 7);

let adjustedDay = thisDay;

if (thisDay >= cutDay){
    adjustedDay = thisDay - cutDay + 1;
}
...
//need to make cutDay only decided once a month
// if(today.getDate() == 1){
//     cutDay = Math.floor(Math.random() * (31 - 7 + 1) + 7);
// }
...
let HPartsLeftStraight = ["<img class='letter-part H-part' src='straight-H/left-vertical/Straight_Capital_H-10.png'>", 
    ...
    "<img class='letter-part H-part' src='straight-H/left-vertical/Straight_Capital_H-3.png'>"];

let HPartsRightStraight = ["<img class='letter-part H-part' src='straight-H/right-vertical/Straight_Capital_H-11.png'>",
"<img class='letter-part H-part' src='straight-H/right-vertical/Straight_Capital_H-2.png'>",
...
for(let j = 0; j<letterParts.length; j++){
    ...
    console.log(letterParts[j].style.transform);
}
